...
class StereospeadAudioProcessor  : public juce::AudioProcessor
...
public:
    ...
    ~StereospeadAudioProcessor() override;
...
private:
    ...
    std::vector<MidSideSample> midSideBuffer;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StereospeadAudioProcessor)
};
